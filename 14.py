    ...
    try:
        ...
        if choose == 1:
            ...
            while True:
                ...
                #if not True then continue (True = valid)
                    ...
                    if state["drawing_number"] == search:
                        ...
                        try:
                            ...
                            if update == 1:
                                ...
                                if "RELEASED" == update_status or "WIP" == update_status or "OBSOLETE" == update_status:

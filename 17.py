...
while True:
    ...
    try:
        ...
        def search_upper(search):

            search_1 = search[:3]
            search_1 = search_1.upper()
            search_2 = search[3:]
        ...
        if choose == 1:
            while True:    
                ...
                search = input("Enter Drawing number you want to search: ")

                search = search_upper(search)
        ...
        #UPDATE
                ...
                if state:
                    ...
                    try:
                        ...
                        if update == 1:
                            ...
                            update_status = update_status.upper().strip()
            ...
            while True:
                ...
                search = input("Enter Drawing Number you want to delete: ")
                search = search_upper(search)
            ...
            while True:
                ...
                print("WIP")
                print("Obsolete")
                search = input("Enter status of drawing you want to filter: ")
                search = search_upper(search)
